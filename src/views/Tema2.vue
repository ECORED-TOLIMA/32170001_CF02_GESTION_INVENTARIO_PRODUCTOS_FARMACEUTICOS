  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      .col-lg-10
        ...
        p.mb-5(data-aos="fade-right") La prescripción debe cumplir con una estructura estandarizada que garantice su validez, legibilidad, trazabilidad y seguridad para el paciente. Los elementos esenciales de una prescripción médica incluyen:

        .row.justify-content-center.align-items-center(style="display: flex; width: 100%; margin: auto;")
          .col-lg-7.order-lg-1.order-2
            LineaTiempoD.color-acento-botones.especial
              div(numero="1" titulo="Identificación del prestador o profesional prescriptor")
              ...
              div(numero="5" titulo="Diagnóstico o motivo clínico")
              ...
              div(numero="6" titulo="Firma y sello del prescriptor")
    ...
    p(data-aos="fade-right") El cumplimiento de esta estructura no solo garantiza la correcta dispensación y seguimiento del tratamiento, sino que protege la seguridad del paciente y la responsabilidad del profesional. En el ámbito institucional, la validación de la prescripción por parte del personal farmacéutico es obligatoria y forma parte del proceso de farmacovigilancia y garantía de calidad en la atención en salud.

    separador
    #t_2_2.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 2.2 Tipos de prescripción
    
    p.mb-5(data-aos="fade-right") En el contexto de la atención en salud, la prescripción de medicamentos puede clasificarse en diferentes tipos, según diversos criterios como el ámbito de aplicación, el contenido terapéutico, la condición del medicamento o el medio utilizado para su emisión. Esta clasificación es fundamental para entender el alcance, las responsabilidades y los procedimientos asociados a cada tipo de prescripción. A continuación, se describen los tipos más relevantes en el sistema de salud colombiano:
    ...
    .row.justify-content-center.mb-5(style="display: flex; width: 100%; margin: auto;")
      .col-lg-8(data-aos="flip-up")
        AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--C05")
          div(titulo="Prescripción ambulatoria")
            p.mb-0 Se refiere a la indicación de medicamentos para pacientes que no requieren hospitalización. Generalmente se realiza en consulta externa y su objetivo es permitir el tratamiento desde el hogar, bajo supervisión médica periódica.
          div(titulo="Prescripción institucional")
            p.mb-0 Es aquella que se realiza dentro de una institución prestadora de servicios de salud (IPS), dirigida a pacientes hospitalizados. Incluye medicamentos para manejo intrahospitalario, de uso inmediato o continuo, y requiere seguimiento por parte del personal clínico y farmacéutico.
          div(titulo="Prescripción por principio activo (nombre genérico)")
            p.mb-0 Consiste en prescribir medicamentos utilizando la Denominación Común Internacional (DCI). Esta práctica es promovida por el Ministerio de Salud para fomentar el acceso y uso racional de medicamentos, priorizando la equivalencia terapéutica sobre las marcas comerciales.
          div(titulo="Prescripción de medicamentos no PBS (Plan de Beneficios en Salud)")
            p.mb-0 Se realiza mediante el sistema MIPRES y permite prescribir tecnologías en salud no incluidas en el PBS, cuando se justifique clínicamente su necesidad. Este tipo de prescripción requiere un soporte técnico-científico y está sujeta a auditoría.
          div(titulo="Prescripción verbal")
            p.mb-0 Utilizada en situaciones de urgencia o emergencia, especialmente en el ámbito hospitalario. Debe ser registrada posteriormente en la historia clínica y confirmada por escrito en el menor tiempo posible.
          div(titulo="Prescripción electrónica")
            p.mb-0 Consiste en el uso de plataformas digitales para emitir y registrar órdenes médicas, garantizando trazabilidad, reducción de errores y mayor eficiencia en el sistema de salud. En Colombia, MIPRES es un ejemplo de prescripción electrónica obligatoria en ciertos casos.
          div(titulo="Prescripción de medicamentos controlados")
            p.mb-0 Corresponde a la prescripción de sustancias sujetas a fiscalización (como psicotrópicos o estupefacientes). Este tipo de prescripción debe cumplir con requisitos específicos establecidos por el INVIMA y debe hacerse en recetarios oficiales autorizados por la autoridad sanitaria.    
      .col-lg-4.col-6.col-md-6.col-8.order-lg-2.order-1.mb-lg-0.mb-4.d-none.d-lg-block(data-aos="fade-left")
        figure
          img(src='@/assets/curso/temas/tema2/img04.png', alt='Imagen decorativa')

    p(data-aos="fade-right") Cada tipo de prescripción exige un nivel de responsabilidad clínica y legal, así como un proceso específico de validación, dispensación y seguimiento. La correcta clasificación y aplicación de cada tipo permite optimizar los recursos del sistema de salud y garantizar una atención segura, oportuna y centrada en el paciente.

    separador
    #t_2_3.titulo-segundo.color-acento-contenido(data-aos="flip-up")
      h2 2.3 Prescripción de medicamentos controlados
    
    p(data-aos="fade-right") La prescripción de medicamentos controlados corresponde a la indicación médica de sustancias sujetas a fiscalización por su alto riesgo de dependencia, abuso o desvío. Estos medicamentos, aunque necesarios en el tratamiento de múltiples patologías, deben ser prescritos con especial cuidado y conforme a las regulaciones establecidas en Colombia.
    p.mb-5(data-aos="fade-right") Entre los medicamentos controlados más comunes se encuentran:

    .tarjeta--container.row.mb-5
      .col-md-6.col-md-0.mb-4.tarjeta.tarjeta--C06.p-5
      ...
      .col-md-6.col-md-0.mb-4.tarjeta.tarjeta--C01.p-5
        .row.justify-content-center.mb-4
          .col-lg-4.col-6
            figure
    ...
    p.mb-5(data-aos="fade-right") Este tipo de medicamentos debe ser prescrito en un recetario oficial numerado, suministrado por el Fondo Nacional de Estupefacientes o la Secretaría de Salud departamental. El formato exige:

    .row.justify-content-center.mb-5
      .col-lg-4.col-sm-6.mb-4
        .row.justify-content-center.h-100.w-100
          .col-lg-auto.col-3.col-sm-2.px-0(data-aos="flip-up")
    ...
    p.mb-5(data-aos="fade-right") A continuación, se presenta un caso demostrativo de cómo debe ser registrada una prescripción de medicamento controlado en el recetario oficial, cumpliendo con todos los requisitos normativos y clínicos establecidos.

    .row.justify-content-center.p-4.mb-5(style="display: flex; width: 100%; margin: auto;")
      .col-lg-11
        .row.justify-content-center.mb-5(style="display: flex; width: 100%; margin: auto;")
        ...
        p.mb-5(data-aos="fade-right") Este registro debe hacerse en el recetario oficial y quedar consignado en la historia clínica del paciente. Además, el servicio farmacéutico debe llevar un estricto control de entrada y salida de estos medicamentos, conservando copia de la fórmula para inspección sanitaria.

        .row.justify-content-center
          .cajon.cajon.C02.color-secundario.p-4
            p.mb-0(data-aos="fade-right") En los casos en que los medicamentos no estén incluidos en el Plan de Beneficios en Salud (PBS), su prescripción deberá hacerse a través del aplicativo <b>MIPRES</b>. Esto permite garantizar la trazabilidad y evitar el uso inapropiado de estas sustancias.

    p(data-aos="fade-right") La correcta prescripción y dispensación de medicamentos controlados es un proceso crítico que exige conocimiento normativo, responsabilidad profesional y coordinación con el servicio farmacéutico institucional.
    ...
    p(data-aos="fade-right") La verificación de autenticidad y consistencia en la prescripción médica es un paso fundamental para garantizar la seguridad del paciente y el cumplimiento normativo en el servicio farmacéutico. Esta verificación permite confirmar que la fórmula es válida, está correctamente diligenciada y que no contiene errores que puedan comprometer el tratamiento.
    p.mb-5(data-aos="fade-right") A continuación, se describen algunas técnicas clave utilizadas en este proceso:
    ...
    .row.justify-content-center
      .col-lg-10
        .cronologia.mb-5
          .contenedor
            .tarjeta-evento.tarjeta-evento--paso1(data-aos="fade-left")
              ...
              .tarjeta-cuerpo.p-4
                p.mb-0 Se verifica que la prescripción esté firmada y sellada por un profesional autorizado, y que la firma sea legible y coincida con los registros disponibles.
        ...
        p(data-aos="fade-right") Estas técnicas fortalecen la calidad de la atención farmacéutica y ayudan a prevenir errores que puedan poner en riesgo la salud del usuario.

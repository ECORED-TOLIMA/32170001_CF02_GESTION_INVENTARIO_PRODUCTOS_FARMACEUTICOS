export default {
  ...
  complementario: [
    ...
    {
      tema:
        '5. Verificación de la calidad y legalidad de productos farmacéuticos',
      referencia:
  ...
  referencias: [
    ...
    {
      referencia:
        'Departamento Administrativo de la Función Pública. (2014). Decreto 351 de 2014: Por el cual se reglamenta la gestión integral de los residuos generados en la atención en salud y otras actividades. ',
      link:
    ...
    {
      referencia:
        'Ministerio de la Protección Social. (2007). Resolución 1403 de 2007: Por la cual se determina el Módelo de Gestión del Servicio Farmacéutico.',
      link:
        'https://autorregulacion.saludcapital.gov.co/leyes/Resolucion_1403_de_2007.pdf',
    },
    {
      referencia:
        'Ministerio de Salud. (1995). Decreto 677 de 1995: Por el cual se reglamenta parcialmente el Régimen de Registros y Licencias.',
      link:
        'https://www.funcionpublica.gov.co/eva/gestornormativo/norma.php?i=9751',
    },
    {
      referencia:
        'Ministerio de Salud y Protección Social. (2004). Resolución 886 de 2004: Por la cual se adoptan los criterios para la clasificación de los medicamentos de venta sin prescripción facultativa o venta libre.',
      link:
    ...
    {
      referencia:
        'Ministerio de Salud y Protección Social. (2013a). Resolución 1441 de 2013: Por la cual se definen los procedimientos y condiciones que deben cumplir los Prestadores de Servicios de Salud.',
      link:
        'https://www.minsalud.gov.co/sites/rid/Lists/BibliotecaDigital/RIDE/DE/DIJ/resolucion-1441-de-2013.pdf',
    },
    {
      referencia:
        'Ministerio de Salud y Protección Social. (2013b). Resolución 1604 de 2013: Por la cual se reglamenta el artículo 131 del Decreto Ley 019 de 2012.',
      link:
